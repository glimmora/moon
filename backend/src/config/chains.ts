...
export const chainConfigs: ChainConfig[] = [
  {
    ...
    factoryAddress: env.FACTORY_BSC,
    nativeSymbol: "BNB",
    isTestnet: false,
  },
  {
    ...
    factoryAddress: env.FACTORY_BASE,
    nativeSymbol: "ETH",
    isTestnet: false,
  },
  {
    ...
    factoryAddress: env.FACTORY_ARBITRUM,
    nativeSymbol: "ETH",
    isTestnet: false,
  },
  {
    ...
    factoryAddress: env.FACTORY_BSC_TESTNET,
    nativeSymbol: "tBNB",
    isTestnet: true,
  },
  {
    ...
    factoryAddress: env.FACTORY_BASE_SEPOLIA,
    nativeSymbol: "ETH",
    isTestnet: true,
  },
  {
    ...
    factoryAddress: env.FACTORY_ARBITRUM_SEPOLIA,
    nativeSymbol: "ETH",
    isTestnet: true,
  },
  {
    ...
    factoryAddress: env.FACTORY_ETHEREUM_SEPOLIA,
    nativeSymbol: "ETH",
    isTestnet: true,
  },
];
