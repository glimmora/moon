...
function LazyPage({ element }: { element: React.ReactElement }) {
  return (
    <Suspense fallback={<div className="flex items-center justify-center min-h-[50vh]"><div className="h-8 w-8 rounded-full border-2 border-moon-500/30 border-t-moon-500 animate-spin" /></div>}>
